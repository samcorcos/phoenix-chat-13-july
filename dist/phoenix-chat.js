...
var PhoenixChatSidebar = exports.PhoenixChatSidebar = function (_React$Component2) {
  ...
  function PhoenixChatSidebar(props) {
    ...
    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(PhoenixChatSidebar).call(this, props));

    _this2.closeChat = _this2.closeChat.bind(_this2);
    _this2.state = {
      chat: [{ name: "Client", content: "Test" }, { name: "John", content: "Foo" }, { name: "Client", content: "Bar" }]
    };
    return _this2;
  }
  ...
  _createClass(PhoenixChatSidebar, [{
    ...
    key: 'render',
    value: function render() {
      var list = this.state.chat.map(function (bubble) {
        return _react2.default.createElement(
          'div',
          { style: bubble.name === "Client" ? _style2.default.chatRight : _style2.default.chatLeft },
          bubble.content
        );
      });
